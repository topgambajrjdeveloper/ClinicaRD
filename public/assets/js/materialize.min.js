                      ...
                      position: function() {
                          ...
                          return (
                              ...
                              e.style &&
                                  ...
                                  (n.left +=
                                      parseFloat(e.style.borderLeftWidth) ||
                                      0)),
                          ...
                          if (8 >= d) l = f.css(e, r);
                              ...
                              (g =
                                  i(e) === a
                                      ...
                                      : (i(
                                            e
                                        ).computedStyle = t.getComputedStyle(
                                            e,
                                            null
                                        ))),
                  ...
                  function n() {
                      function e(e) {
                                      ...
                                      ((s.display !== a &&
                                          ...
                                          s._cacheValues && E && E[z]
                                              ...
                                              ? M === a
                                                  ...
                                                  : (B =
                                                        S.Hooks.templates[I][1])
                                              : M === a &&
                                                (M = S.getPropertyValue(o, z));
                                      var W,
                                          G,
                                          Y,
                                          D = !1;
                          ...
                          l.element &&
                              ...
                              R.push(l),
                              "" === s.queue &&
                                  ((i(o).tweensContainer = l), (i(o).opts = s)),
                              (i(o).isAnimating = !0),
                              V === w - 1
                                  ? (b.State.calls.push([
                                        R,
...
(function($) {
    $.fn.collapsible = function(options, methodParam) {
        ...
        return this.each(function() {
            ...
            removeEventHandlers();
            $this.on("click.collapse", "> li > .collapsible-header", function(
                e
            ) {
        ...
        this.each(function() {
            ...
            function updateOptions() {
                ...
                if (origin.data("stoppropagation") !== undefined)
                    curr_options.stopPropagation = origin.data(
                        "stoppropagation"
                    );
            }
            updateOptions();
            ...
            function placeDropdown(eventType) {
                ...
                if (currAlignment === "left") {
                    ...
                    activates.stop(true, true).css({ opacity: 0, left: 0 });
                    var offsetRight =
                ...
                setTimeout(function() {
                    $(document).on("click." + activates.attr("id"), function(
                        e
                    ) {
                        hideDropdown();
...
(function($) {
    ...
    var Modal = (function() {
        function Modal($el, options) {
            ...
            Modal._increment++;
            Modal._count++;
            this.$overlay[0].style.zIndex = 1e3 + Modal._increment * 2;
            this.$el[0].style.zIndex = 1e3 + Modal._increment * 2 + 1;
                    ...
                    value: function handleTriggerClick(e) {
                        ...
                        if (e.target && $trigger.length) {
                            ...
                            if (modalId) {
                                ...
                                modalId = $trigger[0].getAttribute(
                                    "data-target"
                                );
                            }
...
(function($) {
    ...
    window.Materialize.toast = function(
        message,
        displayLength,
        className,
        completeCallback
        ...
        init: function(options) {
            ...
            $(this).each(function() {
                ...
                if (options.edge == "left") {
                    ...
                    menu.addClass("right-aligned").css(
                        "transform",
                        "translateX(100%)"
                    );
            ...
            return this.each(function() {
                ...
                if (!$.isEmptyObject(data)) {
                    ...
                    $input
                        ...
                        .on("keyup.autocomplete focus.autocomplete", function(
                            e
                        ) {
                            count = 0;
    ...
    $.fn.material_chip = function(options) {
        ...
        this.handleEvents = function() {
            ...
            self.$document
                ...
                .on("focusin.chips", SELS.CHIPS + " " + SELS.INPUT, function(
                    e
                ) {
            ...
            self.$document
                ...
                .on("focusout.chips", SELS.CHIPS + " " + SELS.INPUT, function(
                    e
                ) {
                    var $currChips = $(e.target).closest(SELS.CHIPS);
...
(function($) {
    Materialize.fadeInImage = function(selectorOrEl) {
        ...
        $(element).velocity(
            { opacity: 1 },
            { duration: 650, queue: false, easing: "easeOutSine" }
        );
        $(element).velocity(
            { opacity: 1 },
            {
    ...
    function PickerConstructor(ELEMENT, NAME, COMPONENT, OPTIONS) {
        ...
        function prepareElement() {
            ...
            if (!SETTINGS.editable) {
                $ELEMENT
                    .on("focus." + STATE.id + " click." + STATE.id, function(
                        event
                    ) {
                        event.preventDefault();
                        P.$root.eq(0).focus();
...
(function(factory) {
    ...
    DatePicker.prototype.navigate = function(type, value, options) {
        ...
        if (isTargetArray || isTargetObject) {
            ...
            while (
                new Date(targetYear, targetMonth, targetDate).getMonth() !==
                targetMonth
            ) {
                targetDate -= 1;
            }
    ...
    var methods = {
        init: function(options) {
            return this.each(function() {
                ...
                var tapTargetOriginEl = tapTargetWrapper.find(
                    ".tap-target-origin"
                );
