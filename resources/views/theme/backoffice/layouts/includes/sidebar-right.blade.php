              ...
              <div id="activity" class="col s12">
                ...
                <div class="activity">
                  ...
                  <div class="col s9 recent-activity-list-text">
                    ...
                    <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Jim Doe Purchased new equipments
                      for zonal office.</p>
                  </div>
                  <div class="recent-activity-list chat-out-list row mb-0">
                    ...
                    <div class="col s9 recent-activity-list-text">
                      ...
                      <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Your Next flight for USA will
                        be on 15th August 2015.</p>
                    </div>
                  </div>
                  <div class="recent-activity-list chat-out-list row mb-0">
                  ...
                  <div class="recent-activity-list chat-out-list row mb-0">
                    ...
                    <div class="col s9 recent-activity-list-text">
                      ...
                      <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Jessy Jay open a new store at
                        S.G Road.</p>
                    </div>
                  </div>
